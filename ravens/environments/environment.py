...
class ContinuousEnvironment(Environment):
  ...
  def __init__(self, *args, **kwargs):
    ...
    # Redefine action space, assuming it's a suction-based task. We'll override it in
    # `reset()` if that is not the case.
    self.position_bounds = gym.spaces.Box(
  ...
  def set_task(self, task):
    ...
    # Redefine the action-space in case it is a pushing task. At this point, the ee has
    # been instantiated.
